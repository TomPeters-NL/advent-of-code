    ...
    foreach ($vectorsY as $dY) {
        foreach ($vectorsX as $dX) {
            ...
            if ($wordSearch[$nY][$nX] === $letter) {
                ...
                findLetters($wordSearch, $nX, $nY, $dX, $dY, $nextLetter, $occurrences, $diagonalsOnly);
            }
        }
    }
}
...
{
    $wordSearch = prepareWordSearch($input);
    ...
    foreach ($wordSearch as $y => $line) {
        foreach ($line as $x => $letter) {
            ...
            findLetters($wordSearch, $x, $y, null, null, 'M', $occurrences);
        }
    }
...
function partTwo(array $input): int
{
    ...
    foreach ($wordSearch as $y => $line) {
        foreach ($line as $x => $letter) {
            ...
            findLetters($wordSearch, $x, $y, null, null, 'A', $occurrences, true);
        }
    }
